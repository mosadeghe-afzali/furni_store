...
//    'date_format' => ':attribute فرمت باید به شکل :format وارد شود',
    'date_format' => 'فرمت :attribute صحیح نمی باشد.',
...
//    'email' => ':attribute ایمیل آدرس معتبر نیست.',
    'email' => ':attribute را صحیح وارد کنید. مثال :a.b@example.com',
    'ends_with' => ':attribute آخرین مقدار باید شامل این موارد باشد: :values',
    'exists' => ':attribute وارد شده معتبر نیست.',//مورد
    ...
    'cidr' => ':attribute باید به فرمت cidr وارد شود.',
    ...
    'min' => [
        ...
        'file' => ':attribute نمی توانتد کمتر از :min کیلوبایت باشد.',
        'string' => ':attribute نمی تواند کمتر از :min کارکتر باشد.',
        'array' => ':attribute نمی تواند کمتر از :min آیتم باشد.',
    ],
    'not_in' => ':attribute معتبر نیست.',
    'not_regex' => ':attribute فرمت وارد شده معتبر نیست.',
    'numeric' => ':attribute را عدد وارد نمایید.',
    ...
    'required_if' => 'فیلد :attribute اجباری است.',
    'required_unless' => 'فیلد :attribute اجباری است.',
    'required_with' => 'فیلد :attribute اجباری است.',
    'required_with_all' => 'فیلد :attribute اجباری است.',
    'required_without' => 'فیلد :attribute اجباری است.',
    'required_without_all' => 'فیلد :attribute اجباری است.',
...
//    'unique' => ':attribute این مقدار قبلا ثبت شده و تکراری است.',
    ...
    'mobile' => 'فرمت شماره همراه صحیح نمی باشد.',
    'identification_num' => 'فرمت کد ملی صحیح نمی باشد.',

    'http_code' => 'فرمت :attribute باید منطبق با فرمت کد وضعیت استاندارد پروتکل http باشد',
    ...
    */
    ...
    'custom' => [
        ...
        'more_than' => 'بیش از :value :attribute',
        'less_than' => 'کمتر از :value :attribute',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'user_cards.card_number' => 'شماره کارت',
        'card_number' => 'شماره کارت',
        'sheba_number' => 'شماره شبا',
        'duration' => 'بازه زمانی',
        'wealth_id' => 'شناسه سرمایه'
    ],
